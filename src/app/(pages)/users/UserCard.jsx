      ...
      <div className="bg-gradient-to-r from-[#001976] to-[#004aad] w-[320px] h-[250px] text-white rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col items-center gap-5">
        ...
        <div className="flex gap-5 w-full">
          <button
            ...
            className="flex-1 bg-white text-[#001976] py-3 px-8 rounded-3xl text-xl font-semibold transform transition-all duration-300 hover:bg-yellow-500 hover:text-black hover:scale-105 shadow-2xl hover:shadow-xl"
          >
            تعديل الحالة
          </button>
          <button
            onClick={handleSuspendClick}
            className="flex-1 bg-red-600 hover:bg-red-700 text-white py-3 px-8 rounded-3xl text-xl font-semibold flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-xl"
          >
            <ShieldAlert size={20} />
            إيقاف مع تنبيه
          </button>
          ...
          <div className="bg-white w-[450px] p-8 rounded-3xl shadow-xl transform transition-all duration-300 ease-in-out">
            ...
            <div className="flex justify-between">
              <button
                ...
                className="bg-gray-300 text-black py-3 px-8 rounded-3xl font-semibold hover:bg-gray-400 transition-all duration-200 text-lg"
              >
                إغلاق
              </button>
              <button
                onClick={handleSubmitReason}
                className="bg-red-600 text-white py-3 px-8 rounded-3xl font-semibold hover:bg-red-700 transition-all duration-200 text-lg"
              >
                إرسال
              </button>
            </div>
